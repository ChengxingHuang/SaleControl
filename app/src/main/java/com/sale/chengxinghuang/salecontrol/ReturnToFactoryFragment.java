 ...
 */
public class ReturnToFactoryFragment extends Fragment implements View.OnClickListener  {

    private static final String TAG = "ReturnToFactoryFragment";
    ...
    public ReturnToFactoryFragment() {
