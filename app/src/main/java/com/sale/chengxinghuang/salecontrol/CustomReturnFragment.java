 ...
 */
public class CustomReturnFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = "CustomReturnFragment";
